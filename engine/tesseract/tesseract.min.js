          ...
          ;(n = function () {
            return function () {
              ...
              for (var n, o = document.createElement('a'), i = 1; i < t; i++)
                (o.href = arguments[i]), (n = o.href), (e.href = n)
        ...
        793: (t, e, r) => {
          ...
          function o() {
            ...
            return (
              ...
              s(w, 'constructor', d),
              s(d, 'constructor', y),
              (y.displayName = s(d, u, 'GeneratorFunction')),
              (t.isGeneratorFunction = function (t) {
                var e = 'function' == typeof t && t.constructor
                return (
                  !!e &&
              ...
              (t.mark = function (t) {
                return (
                  Object.setPrototypeOf
                    ...
                    : ((t.__proto__ = d), s(t, u, 'GeneratorFunction')),
            ...
            var k = function (t, e) {
              ...
              P = function (t) {
                ...
                return new Promise(function (t, i) {
                  d(
                    '['.concat(e, ']: Start ').concat(r, ', action=').concat(n)
                  ),
                    k(n, t),
                    _(n, i),
                    E(S, { workerId: e, jobId: r, action: n, payload: o })
                })
              },
              N = function (t) {
                return P(y({ id: t, action: 'load', payload: { options: u } }))
              },
              A = function (t, e, r) {
                return P(
                  y({
              ...
              I = function (t, e, r) {
                return P(
                  y({ id: r, action: 'FS', payload: { method: t, args: e } })
                )
              },
              F = function () {
                var t =
              ...
              D = function () {
                var t =
                  ...
                  e = arguments.length > 1 ? arguments[1] : void 0
                return P(
                  y({ id: e, action: 'setParameters', payload: { params: t } })
                )
              },
              M = (function () {
                var t = c(
              ...
              L(S, function (t) {
                ...
                if ('resolve' === o) {
                  ...
                  'recognize' === i
                    ...
                    : 'getPDF' === i &&
                      (u = Array.from(
                        s(s({}, c), {}, { length: Object.keys(c).length })
                      )),
                    l[i]({ jobId: r, data: u })
                } else if ('reject' === o) {
                  if ((m[i](c), !a)) throw Error(c)
                  a(c)
                } else 'progress' === o && n(s(s({}, c), {}, { userJobId: r }))
              }),
              {
                id: e,
                worker: S,
          ...
          t.exports = function (t) {
            ...
            return (
                      ...
                      o.symbols.forEach(function (i) {
                        ...
                        i.push(
                          r(
                            r({}, o),
                            {},
                            { page: t, block: c, paragraph: e, line: n }
                          )
                        )
                    }),
                      o.push(
                        r(r({}, n), {}, { page: t, block: c, paragraph: e })
                      )
                  }),
              ...
              r(
                r({}, t),
                {},
                { blocks: e, paragraphs: n, lines: o, words: i, symbols: a }
              )
            )
          }
        },
