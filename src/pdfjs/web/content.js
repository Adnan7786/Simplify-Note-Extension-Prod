...
const shadowRootContainer = window.createElement('div');
...
window.body.appendChild(shadowRootContainer);

var host = window.getElementById('shadowRootContainer');
var root = host.attachShadow({ mode: 'open' });
const tooltipContainer = window.createElement('div');
...
const shadowElem = window.querySelector('#shadowRootContainer').shadowRoot;
...
// let insideImage = {};
setInterval(() => {
  const imageCollection = window.getElementsByTagName("img");
...
function getWidth() {
  return Math.max(
    window.body.scrollWidth,
    window.documentElement.scrollWidth,
    window.body.offsetWidth,
    window.documentElement.offsetWidth,
...
function getHeight() {
  return Math.max(
    window.body.scrollHeight,
    window.documentElement.scrollHeight,
    window.body.offsetHeight,
    window.documentElement.offsetHeight,
